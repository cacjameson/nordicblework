...
struct _isr_table_entry __sw_isr_table _sw_isr_table[69] = {
	...
	{(const void *)0x135a1, (ISR)0x18f05}, /* 33 */
	...
	{(const void *)0x13319, (ISR)0x18f05}, /* 42 */
	...
	{(const void *)0x130d1, (ISR)0x18f05}, /* 47 */
